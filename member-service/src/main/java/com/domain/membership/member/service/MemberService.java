package com.domain.membership.member.service;

import com.domain.membership.member.dto.MemberSubscribeRequest;
import com.domain.membership.member.dto.MemberResponse;
...
public class MemberService {
    ...
    public MemberResponse subscribe(MemberSubscribeRequest request) {
        ...
        eventPublisher.publishEvent(MembershipEvent.subscribed(member.getUserId(), member.getGrade().name()));
    ...
    public MemberResponse cancel(Long userId) {
        ...
        eventPublisher.publishEvent(MembershipEvent.cancelled(member.getUserId(), member.getGrade().name()));
